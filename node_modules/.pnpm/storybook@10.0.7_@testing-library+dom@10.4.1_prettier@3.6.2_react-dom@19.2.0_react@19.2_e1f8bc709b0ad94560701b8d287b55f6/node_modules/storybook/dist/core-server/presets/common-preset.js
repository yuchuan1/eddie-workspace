...
import {
  getLastEvents,
  getSessionId
} from "../../_node-chunks/chunk-MD57HJIM.js";
import {
  invariant
...
import "../../_node-chunks/chunk-3QRUKHNZ.js";
import {
  loadConfig
} from "../../_node-chunks/chunk-LL7YW7JI.js";
import {
  require_dist
...
var getComponentVariableName = /* @__PURE__ */ __name(async (name) => {
  const camelCase = await import("../../_node-chunks/camelcase-IT57EA7A.js");
...
async function searchFiles({
  ...
  const { globby, isDynamicPattern } = await import("../../_node-chunks/globby-VVSMFUOS.js");
...
var viteFinal = /* @__PURE__ */ __name(async (existing, options) => {
  ...
  const { viteInjectMockerRuntime } = await import("../../_node-chunks/plugin-53K4FV2S.js");
  const { viteMockPlugin } = await import("../../_node-chunks/plugin-J57WYAS6.js");
  const coreOptions = await options.presets.apply("core");
  return {
    ...existing,
    plugins: [
...
var webpackFinal = /* @__PURE__ */ __name(async (config, options) => {
  ...
  const { WebpackMockPlugin } = await import("../../_node-chunks/webpack-mock-plugin-FFF3YTJU.js");
  const { WebpackInjectMockerRuntimePlugin } = await import("../../_node-chunks/webpack-inject-mocker-runtime-plugin-TSBFN4GA.js");
