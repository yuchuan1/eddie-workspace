...
describe('BarChart', () => {
  ...
  it('applies theme correctly', () => {
    const { container } = render(
      <BarChart chartData={mockChartData} theme="dark" />
    );
  ...
  it('renders multiple series with legend and default titles', () => {
    ...
    const { container } = render(
      <BarChart chartData={multiSeriesNoTitleData} />
    );
    expect(container.firstChild).toBeTruthy();
  });
  ...
  it('handles horizontal orientation', () => {
    const { container } = render(
      <BarChart chartData={mockChartData} orientation="horizontal" />
    );
    expect(container.firstChild).toBeTruthy();
  });
  ...
  it('handles horizontal orientation with object xAxis', () => {
    ...
    const { container } = render(
      <BarChart
        chartData={horizontalObjectXAxisData}
