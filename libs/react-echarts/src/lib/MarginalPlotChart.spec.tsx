...
describe('MarginalPlotChart', () => {
  ...
  it('applies theme correctly', () => {
    ...
    const { container } = render(
      <MarginalPlotChart chartData={chartData} theme="dark" />
    );
  ...
  it('accepts configurable bins', () => {
    ...
    const { container } = render(
      <MarginalPlotChart chartData={chartData} bins={8} />
    );
    expect(container.firstChild).toBeTruthy();
  });
  ...
  it('renders with custom colors', () => {
    ...
    const { container } = render(
      <MarginalPlotChart chartData={chartData} colors={colors} />
    );
    expect(container.firstChild).toBeTruthy();
  });
  ...
  it('handles linkPointer disabled', () => {
    ...
    const { container } = render(
      <MarginalPlotChart chartData={chartData} linkPointer={false} />
    );
    expect(container.firstChild).toBeTruthy();
  });
  ...
  it('handles normalize prop', () => {
    ...
    const { container } = render(
      <MarginalPlotChart chartData={chartData} normalize={true} />
    );
    expect(container.firstChild).toBeTruthy();
  });
  ...
  it('handles custom height', () => {
    ...
    const { container } = render(
      <MarginalPlotChart chartData={chartData} height={300} />
    );
    expect(container.firstChild).toBeTruthy();
  });
  ...
  it('handles showMarginalLabels prop', () => {
    ...
    const { container } = render(
      <MarginalPlotChart chartData={chartData} showMarginalLabels={true} />
    );
    expect(container.firstChild).toBeTruthy();
  });
