  ...
  args: {
    chartData: {
      ...
      series: [
        {
          name: 'Group A',
          data: Array.from({ length: 30 }, () => [Math.random() * 50, Math.random() * 50]),
        },
        {
          name: 'Group B',
          data: Array.from({ length: 30 }, () => [50 + Math.random() * 50, 50 + Math.random() * 50]),
        },
      ],
      xAxis: {},
      yAxis: {},
  ...
  args: {
    chartData: {
      ...
      series: [
        {
          name: 'Dense Points',
          data: Array.from({ length: 1000 }, () => [Math.random() * 100, Math.random() * 100]),
        },
      ],
      xAxis: {},
      yAxis: {},
  ...
  args: {
    chartData: {
      ...
      series: [
        {
          name: 'Large Data',
          data: Array.from({ length: 20 }, () => [Math.random() * 10000, Math.random() * 10000]),
        },
      ],
      xAxis: {},
      yAxis: {},
